...
{
	x68k_crtc_set_text_xscroll(0);
	x68k_crtc_set_text_yscroll(0);
	x68k_crtc_set_gp0_xscroll(0);
	x68k_crtc_set_gp0_yscroll(0);
	x68k_crtc_set_gp1_xscroll(0);
	x68k_crtc_set_gp1_yscroll(0);
	x68k_crtc_set_gp2_xscroll(0);
	x68k_crtc_set_gp2_yscroll(0);
	x68k_crtc_set_gp3_xscroll(0);
	x68k_crtc_set_gp3_yscroll(0);
